...
const STRONG_DRY_SCALP_PENALTY = 0.84; // tuned: was 0.78, raised to reduce harsh surfactant underrating

/** Penalty for strong surfactant on damaged hair. */
const STRONG_DAMAGED_PENALTY = 0.87; // tuned: was 0.82, raised to reduce harsh surfactant underrating
