...
const DAMAGED_PROTEIN_BONUS = 1.12; // tuned: was 1.20, reduced due to protein overrating pattern
 ...
 */
const PROTEIN_HUMECTANT_SYNERGY_BONUS = 1.03; // tuned: was 1.06, reduced due to protein overrating pattern
