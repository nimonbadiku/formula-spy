...
export const CONTRADICTORY_CASES: readonly AdversarialCase[] = [
  {
    ...
    expectedFormulaQuality: 30,
    passCondition: "Score must be < 40 due to contradictions",
  },
  {
    ...
    expectedFormulaQuality: 35,
    passCondition: "Score must be < 45 due to contradictions",
  },
  {
  ...
  },
  {
    ...
    expectedFormulaQuality: 20,
    passCondition: "Score must be < 30 due to contradictions",
  },
  {
